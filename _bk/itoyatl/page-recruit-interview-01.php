                    ...
                    <article class="">
                        <div class="discriptionBox">
                            ...
                            <div class="careerCard">
                                ...
                                <h2 class="careerCard-name">I・Y</h2>
                                <p class="careerCard-job">店長</p>
                                <p class="careerCard-text">ドトールコーヒーショップ蒲田西口店にて半年間社員として勤務し、本部研修を受講後2018年よりドトールコーヒーショップ川崎銀柳街店店長として配属、学生、フリーターさん等と年齢も近く、スタッフと歩み寄り、対話を実施しながら店舗運営を実施中。</p>
                            </div>
                        </div>
